...
###### Quick Note: This behaviour will change with version 1.1.1. See [here](https://github.com/andrewrdavidson/PSQualityCheck/wiki/Release-Guide-and-Future-Plans#release-111).
